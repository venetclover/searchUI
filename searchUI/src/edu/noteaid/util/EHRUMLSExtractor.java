...
public class EHRUMLSExtractor {
	...
	private static final Logger LOGGER = Logger.getLogger(EHRUMLSExtractor.class);
	...
	/***
	 * 
	 * extractTermbyPathName is a method that input text file path
	 * and extract the UMLS
	 * 
	...
	public void extractTermbyPathName(String path, String docType){
		...
		serializer.serialize(ttmap, "persist/" + 
				docType + "/" + pf.getPath());
	}
	...
	public void persistMap(HashMap<String, ArrayList<String>> map, String s1, String s2){
